...
i have 30+ years of computing and math experience. i can code "anything" in any language (given enough time).
...
relevantly, this entry provides an anchor in time to contextualize the other successes.
    ...
    const SuccessData(
        title:
            'wrote independent proof for uncountability and sparsity of the Cantor set',
        timestamp: 1038771048,
        tags: ['math', 'research'],
        description: '''
